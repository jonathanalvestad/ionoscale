...
def teach_network(n_type="label",
    ...
    with ms.scope():
        model = tf.keras.models.Sequential([
            ...
            tf.keras.layers.Dropout(0), # 0 = no dropouts 1 = all drops out                                    
            ...
            #tf.keras.layers.Dropout(0.4), # 0 = no dropouts 1 = all drops out
...
teach_network(n_type="label",bs=32, n_epochs=10, N=10)
